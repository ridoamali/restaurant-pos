import { MenuIcon, TableIcon as TableBar, CalendarRange, Truck, Calculator, Settings, LogOut } from "lucide-react"
import { Button } from "@/components/ui/button"

const navItems = [
  { icon: MenuIcon, label: "Menu", color: "text-indigo-800" },
...
export function SidebarNav() {
  return (
    <div className="w-64 p-4 border-r h-screen bg-white">
      <div className="flex items-center gap-2 mb-8 mt-10 lg:mt-0">
        <img
      ...
      <Button
        variant="ghost"
        className="w-full justify-start mt-auto text-gray-600 absolute bottom-4 left-0 right-0 mx-4"
      >
