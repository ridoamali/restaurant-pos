...
export function Cart({ onClose }: CartProps) {
  ...
  return (
    <div className="w-full sm:w-[380px] bg-white border-l flex flex-col h-full">
          ...
          <div key={index} className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex justify-between items-center mt-1">
                <span className="text-indigo-800 font-bold">${item.price.toFixed(2)}</span>
      ...
      <div className="border-t p-4">
        ...
        <Button className="w-full bg-indigo-800 hover:bg-indigo-900 text-white h-12">Place Order</Button>
      </div>
    </div>
  )
}
